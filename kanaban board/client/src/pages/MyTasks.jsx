      ...
      <div className="flex-1 overflow-y-auto">
        <div className="mx-auto max-w-[1600px] px-6 py-8 md:px-8">
          ...
          <div className="mb-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <MiniStat icon={ListTodo} label="Assigned to you" value={stats.total} tint="#1a7fd4" />
              ...
              {grouped.map((g) => (
                <div key={g.id}>
                  <div className="mb-3 flex items-center gap-2">
                    <span className="h-2.5 w-2.5 rounded-full" style={{ backgroundColor: g.color || "#1a7fd4" }} />
