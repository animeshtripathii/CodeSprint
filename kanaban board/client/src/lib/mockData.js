...
/* ---------------------------------- boards ----------------------------------- */
const boardMetas = [
  { id: "b-roadmap", title: "Product Roadmap", description: "Quarterly planning, OKRs and feature prioritization.", color: "#1a7fd4", owner: "u-alex", members: ["u-maya", "u-diego", "u-priya"], updatedDaysAgo: 0.3,
...
export const getBoardDetail = (id) => {
  ...
  return {
    board: { id, title: "Untitled board", description: null, color: "#1a7fd4", owner_id: currentUser.id, created_at: iso(), updated_at: iso() },
    columns,
    tasks: [],
