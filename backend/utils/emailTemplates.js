...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background: #0f0f0f; color: #f1f1f1; border-radius: 12px; overflow: hidden;">
  <div style="background: linear-gradient(135deg, #6c63ff, #3ecf8e); padding: 24px; text-align: center;">
    <h1 style="margin: 0; font-size: 24px; color: #fff;">🎯 Task Assigned — HackForge</h1>
  </div>
  <div style="padding: 24px;">
    ...
    <p>Log in to HackForge to view task details, update your status, and stay on track!</p>
  ...
  <div style="padding: 16px; text-align: center; color: #888; font-size: 12px;">© 2024 HackForge. All rights reserved.</div>
</div>`;

const memberJoinedTemplate = ({ memberName, teamName, hackathonTitle }) => `
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background: #0f0f0f; color: #f1f1f1; border-radius: 12px; overflow: hidden;">
  <div style="background: linear-gradient(135deg, #6c63ff, #3ecf8e); padding: 24px; text-align: center;">
    <h1 style="margin: 0; font-size: 24px; color: #fff;">🎉 New Member Joined — HackForge</h1>
  </div>
  <div style="padding: 24px;">
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background: #0f0f0f; color: #f1f1f1; border-radius: 12px; overflow: hidden;">
  <div style="background: linear-gradient(135deg, #6c63ff, #3ecf8e); padding: 24px; text-align: center;">
    <h1 style="margin: 0; font-size: 24px; color: #fff;">📦 Submission Update — HackForge</h1>
  </div>
  <div style="padding: 24px;">
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background: #0f0f0f; color: #f1f1f1; border-radius: 12px; overflow: hidden;">
  <div style="background: linear-gradient(135deg, #6c63ff, #3ecf8e); padding: 24px; text-align: center;">
    <h1 style="margin: 0; font-size: 24px; color: #fff;">⭐ Review Posted — HackForge</h1>
  </div>
  <div style="padding: 24px;">
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background: #0f0f0f; color: #f1f1f1; border-radius: 12px; overflow: hidden;">
  <div style="background: linear-gradient(135deg, #6c63ff, #3ecf8e); padding: 24px; text-align: center;">
    <h1 style="margin: 0; font-size: 24px; color: #fff;">📋 Registration ${status} — HackForge</h1>
  </div>
  <div style="padding: 24px;">
